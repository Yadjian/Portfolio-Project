...
export class ProfileController {
  ...
  updateProfile(
    ...
    // On passe l'ID, les nouvelles données et le fichier photo (si présent) au service
    return this.profileService.updateUserProfile(userId, updateProfileDto, photoFile);
  }
