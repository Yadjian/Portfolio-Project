...
export class UpdateProfileDto {
  ...
  @MaxLength(500, {
    message: 'La localisation WKT est trop longue (max 500 caractères)',
  })
  locationWKT?: string;
  ...
  @ValidateIf(
    (o) =>
      o.interestedInCategoryIds !== undefined &&
      o.interestedInCategoryIds !== null,
  )
  @IsArray({ message: 'Les catégories doivent être un tableau' })
  @IsUUID('4', {
    each: true,
    message: 'Chaque catégorie doit être un UUID valide',
  })
  ...
  @IsString({
    message: 'La lettre de motivation doit être une chaîne de caractères',
  })
  @MaxLength(10000, {
    message: 'La lettre de motivation est trop longue (max 10 000 caractères)',
  })
  @Transform(({ value }) => value?.trim())
  ...
  @IsOptional()
  @ValidateIf(
    (o) => o.desiredJobTitle !== undefined && o.desiredJobTitle !== null,
  )
  @IsString({
    message: 'Le titre du poste désiré doit être une chaîne de caractères',
  })
  @MaxLength(150, {
    message: 'Le titre du poste est trop long (max 150 caractères)',
  })
  @Transform(({ value }) => value?.trim())
  ...
  @ValidateIf(
    (o) =>
      o.desiredExperienceLevel !== undefined &&
      o.desiredExperienceLevel !== null,
  )
  ...
  @ValidateIf(
    (o) =>
      o.desiredContractTypes !== undefined && o.desiredContractTypes !== null,
  )
  ...
  @ArrayMaxSize(10, {
    message: 'Trop de types de contrat sélectionnés (max 10)',
  })
  ...
  @IsString({
    message: 'La description de recherche doit être une chaîne de caractères',
  })
  @MaxLength(5000, {
    message:
      'La description de recherche est trop longue (max 5 000 caractères)',
  })
  @Transform(({ value }) => value?.trim())
