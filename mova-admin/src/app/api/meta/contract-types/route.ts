...
/**
 * Fetch all contract types from the backend metadata API.
...
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/meta/contract-types`, {
      headers: {
    ...
    console.error('Erreur API contract-types:', error);
    return NextResponse.json(
